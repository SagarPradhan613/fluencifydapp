...
const GroupMobCard = ({group,roi,last7days,totalBuy}) => {
    return (
        <>
            <div class="grid grid-cols-5 gap-4 lg:grid-cols-9 justify-center items-center rounded-[15px] bg-[#191919]">
                <div class="lg:col-span-2 col-span-2 font-semibold lg:text-xs  p-4 ">
                    <div>
                        <p className='font-semibold text-xs opacity-50'>Group</p>
                    </div>
                    <div>
                        <p className='whitespace-nowrap font-semibold text-base'>{group}</p>
                    </div>
                </div>
                <div class="lg:col-span-2 col-span-2 font-semibold lg:text-xs  p-4 ">
                    <div>
                ...
                <div class="lg:col-span-2 col-span-2 font-semibold lg:text-xs  table-long-text whitespace-nowrap p-4 ">
                    <div>
                        <p className='font-semibold text-xs opacity-50'>Buy Volume in last 7 Days</p>
                    </div>
                    <div>
                        <p className='font-semibold text-base mt-2'>{last7days}</p>
                    </div>
                </div>
                <div class="lg:col-span-2 col-span-2 font-semibold lg:text-xs  p-4 table-long-text whitespace-nowrap ">
                    <div>
                        <p className='font-semibold text-xs opacity-50'>Total Buy Volume ( $ )</p>
                    </div>
                    <div>
                        <p className='font-semibold text-base whitespace-nowrap mt-2'>{totalBuy}</p>
                    </div>
                </div>
