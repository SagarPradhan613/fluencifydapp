...
import './Wallet.css'
import Deskwalletcard from './Deskwalletcard';
import Mobwalletcard from './Mobwalletcard';
...
const Wallet = () => {
  ...
  const handleCopyClick = () => {
    "0x14565000000000000000000000000000000000000000000000000861";
    document.execCommand('copy');
    // Optionally, you can give some visual feedback to the user (e.g., change button text)
  };
  ...
  const data = [
    {
      wallet: "0x14565000000000000000000000000000000000000000000000000861",
      pl: "14.057 %",
      totalBuy: "7284657",
      price: "456.046854 $",
    },
    ...
    <div className='responsive-container-padding-dashboard lg:mb-20 relative-hero-padding lg:py-10 poppins lg:px-20 px-0 py-3'>
      ...
      <div className='lg:hidden block'>
        <div className='text-white poppins lg:hidden block'>
          ...
          <div className='mt-4 bg-[#111111] w-full  flex-col py-6 flex justify-center items-center '>
            <p className='font-semibold text-xl'>Wallets Influenced By KOLs</p>
          </div>
      ...
      <div className='flex bg-[#111111] lg:bg-[transparent] lg:mt-6 px-8 lg:px-0  text-white'>
        <div className='p-8 hidden lg:flex flex-col justify-between w-[30%] bg-[#111111] rounded-[25px]'>
          <div>
            ...
            <Link href="/historical">
              <div className='bg-[#2D2D2D] mt-4 rounded-[15px] transform transition-all duration-300 ease-in-out hover:border-[#1FED8B] justify-start items-center border border-[#5A5A5A] flex px-4 py-2'>
            ...
            <Link href="/wallet">
              <div className='active-link-wallet mt-4 transform transition-all duration-300 ease-in-out hover:border-[#1FED8B] rounded-[15px] justify-start items-center border border-[#5A5A5A] flex px-4 py-2'>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                ...
                <p className='text-white  text-base font-semibold ml-4'>Wallets</p>
        ...
        <div className='lg:ml-6 bg-[#111111] text-white rounded-[25px] pb-20 w-full lg:py-12 lg:px-12'>
          <div className='lg:flex items-center block justify-between' >
            <div className='hidden lg:block'>
              <p className='text-3xl font-semibold'>Wallets Influenced By KOLs</p>
            </div>
            <div className='relative flex flex-col justify-center'>
              <div className='flex justify-center items-center'>
                <div onClick={() => { setDropDown(!dropDown) }} className='flex justify-center items-center rounded-[8px] bg-[#191919] px-4 py-2'>
                  <p className='text-[10px] font-normal mr-4 opacity-50'>{selectedOption}</p>
                ...
                <div onClick={() => { setDropDown2(!dropDown2) }} className='flex justify-center ml-4 items-center rounded-[8px] bg-[#191919] px-4 py-2'>
              ...
              {dropDown ?
                <>
                  <div className='absolute w-[115px] left-10 lg:left-0 top-12 bg-[#191919] gap-2 p-4 rounded-[8px]  flex flex-col justify-start z-50'>
                    <div className='flex items-center' onClick={() => handleOptionClick('BSC')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>BSC</p>
                    </div>
                    <div className='flex items-center' onClick={() => handleOptionClick('Ethereum')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Ethereum</p>
                    </div>
                    <div className='flex items-center ' onClick={() => handleOptionClick('Solana')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Solana</p>
                    </div>
                    <div className='flex items-center' onClick={() => handleOptionClick('Base')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Base</p>
                    </div>
                    <div className='flex items-center' onClick={() => handleOptionClick('Polygon')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Polygon</p>
                    </div>
                    <div className='flex items-center' onClick={() => handleOptionClick('Arbitrum')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Arbitrum</p>
                    </div>
                    <div className='flex items-center' onClick={() => handleOptionClick('Fantom')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Fantom</p>
                    </div>
                  </div>
                </>
                :
              ...
              {dropDown2 ?
                <>
                  <div className='absolute w-[115px] right-6 lg:-right-2 top-12 bg-[#191919] gap-2 p-4 rounded-[8px]  flex flex-col justify-start z-50'>
                    ...
                    <div className='flex items-center' onClick={() => handleOptionClick2('Max Profit %')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Max Profit %</p>
                    </div>
                    <div className='flex items-center ' onClick={() => handleOptionClick2('Max Loss %')}>
                      <p className='opacity-50 mr-2 text-[10px] font-normal text-white whitespace-nowrap'>Max Loss %</p>
                    </div>
                  </div>
                </>
                :
          ...
          <div class="container mx-auto hidden lg:block mt-6 px-2">
            ...
            <div class="lg:grid grid-cols-3 gap-4 lg:grid-cols-9 hidden bg-[#111111]">
              <div class="lg:col-span-2 col-span-1 font-semibold lg:text-xs opacity-50 p-4 ">Wallets</div>
              <div class="lg:col-span-2 col-span-1 font-semibold lg:text-xs opacity-50 p-4 ">Profit / Loss %</div>
              <div class="lg:col-span-2 col-span-1 font-semibold lg:text-xs opacity-50 table-long-text whitespace-nowrap p-4 ">Total Buy Volume</div>
